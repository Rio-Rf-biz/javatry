...
// #1on1: 質問: TDDの勉強してたけど...テストメソッド名を日本語にするか？ by いわたさん
// o 日本人にとっては日本語でいいんじゃないか？
// o 日本語だと曖昧な表現になってしまうことある
// 英語でも十分曖昧な表現はできるので、そこはそこまで変わらないイメージ by jflute
// チームメンバーがどんどん国際化していく想定なのかどうか？ by jflute
// 技術的な制約は、もうもはや無いと考えても良い (昔は文字化けとか認識されてないとかあったけど) by jflute
//
// 苦手な英語で名前付けしてへんてこりんになるよりかは日本語の方が効率が良いと言える。
// 英語が苦手じゃなければもはやどっちでも。
// これって、gitのコミットメッセージでも同じ話だし、なんならコードコメントでも同じ話。
